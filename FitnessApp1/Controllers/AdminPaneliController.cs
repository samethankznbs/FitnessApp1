...
namespace FitnessApp1.Controllers
{
    public class AdminPaneliController : Controller
    {
        ...
        [HttpPost]
        public IActionResult KayitKontrol1(string antrenorad, string antrenorsoyad, string eposta, string telefon, string picture, int uzmanlik,bool cinsiyet,string sifre)
        {
            try
            {
